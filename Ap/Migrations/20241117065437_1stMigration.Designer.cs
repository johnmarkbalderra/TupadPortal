...
namespace Ap.Migrations
{
    ...
    [Migration("20241117065437_1stMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ap.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.Announcement", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.Applicants", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.Attendance", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.AttendanceChecklist", b =>
                {
            ...
            modelBuilder.Entity("Ap.Models.Batch", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "43bc94f0-0fd8-46ff-803b-64a690cafbe9",
                            Name = "admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "09c96909-12da-43d1-b019-7ebba027fb3b",
                            Name = "brgy",
                            NormalizedName = "BRGY"
                        },
                        new
                        {
                            Id = "88b1a0e8-3c05-4005-a160-47f403a05e41",
                            Name = "peso",
                            NormalizedName = "PESO"
                        });
                });
            ...
            modelBuilder.Entity("Ap.Models.Announcement", b =>
                {
                    b.HasOne("Ap.Models.Address", "Address")
            ...
            modelBuilder.Entity("Ap.Models.Applicants", b =>
                {
                    ...
                    b.HasOne("Ap.Models.Batch", "Batch")
                        .WithMany("Applicants")
            ...
            modelBuilder.Entity("Ap.Models.Attendance", b =>
                {
                    b.HasOne("Ap.Models.Applicants", "Applicant")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Ap.Models.ApplicationUser", null)
                        .WithMany()
